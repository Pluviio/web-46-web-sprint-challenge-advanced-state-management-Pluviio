...
const AddForm = (props) => {
    ...
    const { errorSmurf, addSmurf } = props;
    ...
    return(<section>
        ...
        <form onSubmit={handleSubmit}>
            ...
            {
                errorSmurf && <div data-testid="errorAlert" className="alert alert-danger" role="alert">Error: {errorSmurf}</div>
            }
